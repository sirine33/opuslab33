    ...
    <div class="header-background-3 ">
        ...
        <nav class="navbar navbar-expand-lg ">
          ...
          <div class="text-box">
            ...
            <h1 class="heading-2">Let’s make something awesome together.</h1>
            <h3 class="contact-us3">Drop us a line, or give us a heads up if you’re interested in visiting us.</h3>
            </div> 
            </div> 
        </div>
        <section>
        <div class="container-2">
            <div class="contactinfo">
                <div>
                    <h2 class="h2-contact">Contact Info</h2>
                    <ul class="info">
                        <li>
                            <span class="span-contact" ><img src="img/mail.png"></span>
                            <span class="span-contact">labopus.info@gmail.com</span>
                        </li>
                        <li>
                            <span class="span-contact"><img src="img/phone.png"></span>
                            <span class="span-contact">(+216) 24 305 182</span>
                        </li>
                    </ul>
                </div>
                    <ul class="sci">
                        <li><a href="https://www.facebook.com/OpusLab1/"><img class="contact-img" src="img/fb.png"></a></li>
                        <li><a href="https://www.instagram.com/opus__lab/?hl=fr"><img class="contact-img" src="img/insta1.png"></a></li>
                        <li><a  href="https://www.linkedin.com/in/opus-lab-59b724200"><img class="contact-img" src="img/linkedin (1).png"></a></li>
                    </ul>
                </div>
            </div>
            <div class="contactForm">
                <h2 class="h2-contact-1">Send a Message</h2>
                <div class="formBox">
